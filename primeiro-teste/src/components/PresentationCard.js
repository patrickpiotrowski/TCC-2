...
function PresentationCard (){
    return(
        ...
        <Stack>
          ...
          <h3 style={{ margin: '1rem', textAlign: 'justify', textJustify: 'initial', color: "#505050" }}>Se você cursa Engenharia de Computação na UTFPR-CP e está com dificuldades para encontrar um orientador, veio ao lugar certo!
